...
public class NickCheckController {
	...
	/** 상세 페이지*/
    @RequestMapping(value = "/common/ni", method = RequestMethod.POST)
    public Map<String, Object> get_item(@RequestParam("nickname") String nickname) {
        ...
        try {
            // 데이터 조회
        	output = userservice.checkNick(input);
        } catch (Exception e) {
