...
<body>
	<div class="container">
		...
		<p class="sub_title">업종/건강상태 추가</p>
		<div class="admin_link">
			<form id="addForm" action="${pageContext.request.contextPath}/admin/admin_catecondi">
				<div>
					<label for="cateCondiName">업종/건강상태 이름: </label>
					<input type="text" name="cateCondiName" id="cateCondiName" />
				</div>
				<br>
				<div>
					<label for="cateCondiFlag">분류: </label>
					<label><input type="radio" name="cateCondiFlag" id="cateCondiFlag_S" value="S" checked/> 업종</label>&nbsp;&nbsp;&nbsp;&nbsp;
					<label><input type="radio" name="cateCondiFlag" id="cateCondiFlag_C" value="C"/> 건강상태</label>
				</div>
				<hr/>
