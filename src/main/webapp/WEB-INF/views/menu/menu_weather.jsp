...
<body>
	<div class="container">
		...
		<div class="text-center box1" id="weather_food">
			...
			<div id="box7">
				<br> <span id="re-recommend"><img alt="된장찌개"
					src="${pageContext.request.contextPath}/img/menu/doenjan.jpg"
					width="140">
					<h1>된장찌개</h1></span> <br> <br> <span id="re-re"></span> <span
					class="menu_find_btn"> <a><button type="button"
							class="btn btn-ms btn-ttc1" id="btn-retry">&nbsp;&nbsp;재추천&nbsp;&nbsp;</button></a>
					<a href="${pageContext.request.contextPath}/menu/menu_weather_list"><button
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#btn-retry").click(
					function() {
						...
						$("#re-re").html(
								"<img src='${pageContext.request.contextPath}/img/menu/ham.jpg' height='130'>"
										+ "<br>" + "<h1>부대찌개</h1>" + "<br>")
		...
		$
				.getJSON(
						'http://api.openweathermap.org/data/2.5/forecast?lat=37.56826&lon=126.977829&APPID=c689a368e2df5f6e70c8758bec4b5496&units=metric',
						function(data) {
